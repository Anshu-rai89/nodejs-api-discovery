...
import { extractBody, extractHeaders, extractQueryParams, isHttpMethodCall } from "./utils.mjs";

// Function to find API endpoints
export async function discoverEndpoints(directoryPath, framework, objectInstance) {
  const apiEndpoints = [];
